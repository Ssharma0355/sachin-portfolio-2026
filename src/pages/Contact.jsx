...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: <Mail className="w-5 h-5" />, label: 'Email', value: 'ssharma0355@gmail.com', link: 'mailto:ssharma0355@gmail.com' },
    { icon: <Phone className="w-5 h-5" />, label: 'Phone', value: '+919113704388', link: 'tel:+919113704388' },
    { icon: <MapPin className="w-5 h-5" />, label: 'Location', value: 'Bengaluru, Karnataka, India' },
    { icon: <Clock className="w-5 h-5" />, label: 'Time Zone', value: 'IST (UTC+5:30)' },
  ]

  const socialLinks = [
    { icon: <Github className="w-5 h-5" />, label: 'GitHub', link: 'https://github.com/Ssharma0355' },
    { icon: <Linkedin className="w-5 h-5" />, label: 'LinkedIn', link: 'https://www.linkedin.com/in/sachin-sharma-sde/' },
    { icon: <MessageCircle className="w-5 h-5" />, label: 'WhatsApp', link: 'https://wa.me/+919113704388' },
  ]
